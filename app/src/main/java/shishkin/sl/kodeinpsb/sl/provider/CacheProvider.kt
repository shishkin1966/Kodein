...
import shishkin.sl.kodeinpsb.sl.AbsProvider
...
class CacheProvider : AbsProvider(), ICacheProvider {

    companion object {
        const val NAME = "CacheProvider"
    ...
    override operator fun compareTo(other: IProvider): Int {
        return if (other is ICacheProvider) 0 else 1
    }
